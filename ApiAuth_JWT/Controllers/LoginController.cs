...
namespace ApiAuth_JWT.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        [AllowAnonymous]
        public async Task<IActionResult> IniciarSesion(DtoUsuarioLogin usuarioLogin)
        {
        ...
        private async Task<DtoUsuario> AutenticarUsuarioAsync(string usuario, string password)
        {
            ...
            return await Task.Run( ()=> new DtoUsuario()
            {
        ...
        private string GenerarTokenJWT(DtoUsuario usuarioInfo)
        {
            // CREAMOS EL HEADER //
